...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{analysis/am_cvn/plots/AM_CVn_sequence_X42421BZ_light_curve.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\textwidth]{analysis/am_cvn/periodograms/sequence_X42421BZ/short_5_to_90min_periodogram.png}
