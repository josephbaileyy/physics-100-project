...
- `analysis/am_cvn/plots/V0399_UMa_shared_comparison_set_tests.png`
...
- `analysis/am_cvn/plots/V0399_flat_candidate_clipmean_comparison.png`
...
- The AAVSO VSP JSON was saved locally as
  `analysis/am_cvn/aavso/X42421BZ.json`.
...
- `analysis/am_cvn/aavso/X42421BZ.json`
- `analysis/am_cvn/aavso/X42421BZ_sequence_pixel_table.csv`
- `analysis/am_cvn/photometry/sequence_X42421BZ/differential_light_curve.csv`
- `analysis/am_cvn/photometry/sequence_X42421BZ/aperture_photometry.csv`
- `analysis/am_cvn/photometry/sequence_X42421BZ/comparison_control_summary.csv`
- `analysis/am_cvn/photometry/sequence_X42421BZ/photometry_flag_summary.csv`
- `analysis/am_cvn/photometry/sequence_X42421BZ/AM_CVn_sequence_reference_overlay.png`
- `analysis/am_cvn/photometry/sequence_X42421BZ/AM_CVn_early_late_frame_contact_sheet.png`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/period_results.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/fixed_period_sine_summary.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/model_chi2_f_bic_summary_refined.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/period_delta_chi2_intervals.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/bootstrap_period_summary.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/bootstrap_period_family_conditional_intervals.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/bootstrap_period_family_sklearn_gmm_summary.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/literature_period_change_test_summary.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/literature_period_comparisons.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/literature_1992_kruszewski_comparison.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/exploratory_model_comparison.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/exploratory_lomb_scargle_window_summary.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/exploratory_bootstrap_period_summary.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/exploratory_bootstrap_family_intervals.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/exploratory_residual_periodogram_summary.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/exploratory_signal_detectability_summary.csv`
- `analysis/am_cvn/periodograms/sequence_X42421BZ/exploratory_literature_comparison.csv`
- `analysis/am_cvn/plots/AM_CVn_sequence_X42421BZ_light_curve.png`
- `analysis/am_cvn/plots/AM_CVn_period_uncertainty_diagnostics.png`
- `analysis/am_cvn/plots/AM_CVn_exploratory_periodogram_windows.png`
- `analysis/am_cvn/plots/AM_CVn_exploratory_folded_models.png`
- `analysis/am_cvn/plots/AM_CVn_exploratory_bootstrap_family_histograms.png`
- `analysis/am_cvn/plots/AM_CVn_exploratory_residual_periodograms.png`
