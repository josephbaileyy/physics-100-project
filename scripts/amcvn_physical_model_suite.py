...
PHOT_DIR = ROOT / "analysis/project/photometry/AM_CVn_sequence_X42421BZ"
PER_DIR = ROOT / "analysis/project/periodograms/AM_CVn_sequence_X42421BZ"
PLOT_DIR = ROOT / "analysis/project/plots"
...
def bootstrap_free_periods(
    ...
    for i in range(n_boot):
        ...
        p_single, _, fit_single = scan_period(t_min[idx], y[idx], sigma[idx], 5, 12, 700, (1,))
        p_double, _, fit_double = scan_period(t_min[idx], y[idx], sigma[idx], 14, 22, 900, (1, 2))
        rows.append(
            {
                "iteration": i,
...
def main() -> None:
    ...
    boot = bootstrap_free_periods(t_min, y, sigma * scale, args.bootstrap, rng)
